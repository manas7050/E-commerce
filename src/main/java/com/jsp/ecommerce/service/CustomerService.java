...
public class CustomerService {
	...
	public String createOrder(Customer customer, ModelMap map) throws RazorpayException {
		RazorpayClient client = new RazorpayClient("rzp_test_f4vcAPoh0RDZfi", "jjblWSJ6F7NJuPUOtNmDjg4i");
		...
		details.setKeyCode("rzp_test_f4vcAPoh0RDZfi");
	...
	public String completeOrder(int id, String razorpay_payment_id, Customer customer, ModelMap map) {
		...
		customerDao.save(customer);
		 ...
		 emailLogic.sendOrderConfirmation(customer, order);
